        ...
        <div className={style.company}>
          <div>
            ...
            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. 
              ...
              It was popularised in the 1960 s with the release of Letraset sheets containing Lorem Ipsum passages, 
...
export const Head = () => {
  return (
    <>
      <title>Jack of All Trades Official Site</title>
      <description>モダン開発を得意とするJack of All Tradesの公式サイトです。</description>
    </>
  )
}